...
$(window).on("load",function(){$('a[href="#about-title"]').click(function(){let t=0;return t=(700<$(window).width()?$(".main-header__bottom.fixed"):$(".main-header")).outerHeight(),$("html, body").animate({scrollTop:$($.attr(this,"href")).offset().top-t-40},1e3),!1}),$('a[href="#services"]').click(function(){let t=0;return t=(700<$(window).width()?$(".main-header__bottom.fixed"):$(".main-header")).outerHeight(),$("html, body").animate({scrollTop:$($.attr(this,"href")).offset().top-t+30},1e3),!1}),$('a[href="#portfolio"]').click(function(){let t=0;return t=(700<$(window).width()?$(".main-header__bottom.fixed"):$(".main-header")).outerHeight(),$("html, body").animate({scrollTop:$($.attr(this,"href")).offset().top-t+30},1e3),!1}),$('a[href="#footer"]').click(function(){let t=0;return t=(700<$(window).width()?$(".main-header__bottom.fixed"):$(".main-header")).outerHeight(),$("html, body").animate({scrollTop:$($.attr(this,"href")).offset().top-t},1e3),!1}),$("html").on("submit",".form-application",function(t){t.preventDefault();t=$(this);$.ajax({url:"/form-application.php",type:"POST",data:t.serialize(),dataType:"html",success:function(t){$(".pop-up__close").trigger("click"),$("#accepted-hidden").trigger("click")}})}),$("html").on("submit",".form-calculator",function(t){t.preventDefault();t=$(this);$.ajax({url:"/form-calculator.php",type:"POST",data:t.serialize(),dataType:"html",success:function(t){$("#accepted-hidden").trigger("click")}})})});